...
>>>>>>> b867396e1982ea987e6b0d3fa275a8af1b01cd4c
>>>>>>> 062a23b4fef3dfea2b962cb3f0ef019f13e451d3
	// return the total of all the values in the array.
	public static int getTotal(int[][] a) {
		int sum = 0;
		for (int i = 0; i < a.length; i++) {
...
=======
	...
	public static int getRowTotal(int[][] x, int rowCount, int colCount) {
		...
		for (rowIndex = 0; rowIndex < rowCount; rowIndex++) {
			...
			System.out.println("The total for row " + (rowIndex + 1) + " is "
					+ rowTotal);
			rowTotal = 0;
		}
		return rowTotal;
	...
	public static int getColumnTotal(int[][] x, int rowCount, int colCount) {
		...
		for (colIndex = 0; colIndex < colCount; colIndex++) {
			...
			System.out.println("The total for column " + (colIndex + 1)
					+ " is " + columnTotal);
			columnTotal = 0;
		}
		return columnTotal;
	...
	public static int getHighestInRow(int[][] a, int rowCount, int colCount) {
		...
		for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
			...
			System.out.println(highestInRow + " is the highest number in row "
					+ (rowIndex + 1) + ".");
			highestInRow = 0;
		}
		return highestInRow;
	...
	public static int getLowestInRow(int[][] a, int rowCount, int colCount) {
		...
		for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
			...
			System.out.println(lowestInRow + " is the lowest number in row "
					+ (rowIndex + 1) + ".");
